...
<svelte:head>
	<title>Trypillia Programming Language</title>
</svelte:head>
...
<div class="container">
	<main>
		<section id="docs">
			<h2>Швидкий старт</h2>
			<p>Офіційні посібники та довідники зі стандартної бібліотеки для швидкого занурення.</p>
			<ul class="list-group">
				<li>
		...
		<section id="pkg">
			<h2>Пакетний менеджер</h2>
			<p>Створюйте проєкти за допомогою TrypPM.</p>
			<div class="cli-box">
				<div><span>$</span> tryppm init my_project</div>
				<div><span>$</span> cd my_project</div>
				<div><span>$</span> tryppm run</div>
			</div>
		</section>
	</main>
	...
	<aside>
		<div class="sidebar-section">
			<h3>Встановлення</h3>
			<p>Linux / macOS:</p>
			<CodeBlock code="curl -sSL https://tryp.pp.ua/install.sh | sh" />
			<p style="margin-top: 1rem;">Windows (PowerShell):</p>
			<CodeBlock code="irm https://tryp.pp.ua/install.ps1 | iex" />
		</div>

		<div class="sidebar-section">
			<h3>Реліз v1.0-draft</h3>
			<dl class="dl-grid">
				<dt>Версія</dt>
				<dd>1.0.0-beta.2</dd>
				<dt>Дата</dt>
				<dd>24 Жовтня, 2026</dd>
				<dt>Ліцензія</dt>
				<dd>CSSM-ULv2</dd>
			</dl>
		</div>
